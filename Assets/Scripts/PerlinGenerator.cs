...
{
    //public float Noise(int x, int y, int frequency, float redistribution, int octaves, int width, int height)
    //{
    ...
    //    {
    //        e += (1 / (float)i) * Mathf.PerlinNoise(baseFrequency * nx, baseFrequency * ny);
    //        baseFrequency *= 2;
    //    }
